...
### 功能完善
- [x] 文档拖拽导入优化（集成自动分类与 embed/reference 模式）
- [ ] 文件夹迁移功能测试
- [ ] 缩略图生成优化
<!-- - [ ] 内容提取服务增强（OCR、表格还原） -->
<!-- - [ ] 多模态文档解析 -->
